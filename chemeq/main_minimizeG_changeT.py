...
#    print "matA", matA
    ...
    grid_T = np.linspace(400, 2000, P_NUM)
    #P = P_surf * exp(-z/H) => z = 
    for zi in xrange(P_NUM):
        ...
        array_n = minimize(gibbs_energy, array_n0, constraints=cons, bounds=bnds, args=(dict_mol, P_SURF, grid_T[zi]), method='SLSQP', options={'disp': False, 'maxiter':1000})
